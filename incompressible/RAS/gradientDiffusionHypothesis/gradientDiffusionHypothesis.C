...
#include "gradientDiffusionHypothesis.H"
...
defineTypeNameAndDebug(gradientDiffusionHypothesis, 0);
addToRunTimeSelectionTable(RASSFModel, gradientDiffusionHypothesis, dictionary);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

gradientDiffusionHypothesis::gradientDiffusionHypothesis
(
...
tmp<volScalarField> gradientDiffusionHypothesis::DEff() const
{
...
tmp<fvScalarMatrix> gradientDiffusionHypothesis::divDFlux(volScalarField& C) const
{
    return
    (
...
bool gradientDiffusionHypothesis::read()
{
    if (RASSFModel::read())
    {
...
void gradientDiffusionHypothesis::correct()
{
    RASSFModel::correct();
